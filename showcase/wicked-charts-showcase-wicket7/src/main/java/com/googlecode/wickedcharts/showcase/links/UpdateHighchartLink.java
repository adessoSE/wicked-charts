...
public class UpdateHighchartLink extends AjaxLink<Void> {
	 ...
	 */
	public UpdateHighchartLink(final String id, final Chart chart, final Label codeContainer, final Options options) {
		super(id);
		this.chart = chart;
	...
	public void onClick(final AjaxRequestTarget target) {
		...
		((ShowcaseSession) getSession()).setCurrentHighchartOptions(this.options);
		this.codeContainer.setDefaultModel(new StringFromResourceModel(this.options.getClass(),
				this.options.getClass().getSimpleName() + ".java"));
