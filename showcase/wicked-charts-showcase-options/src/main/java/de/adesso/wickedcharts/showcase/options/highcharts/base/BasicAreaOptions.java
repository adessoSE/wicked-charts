 ...
 * href=
 * "http://www.highcharts.com/demo/area-basic">http://www.highcharts.com/demo
 * /area-basic</a>.
 * 
...
public class BasicAreaOptions extends ShowcaseOptions {
  ...
  public BasicAreaOptions() {
    ...
    Axis yAxis = new Axis();
    yAxis
        .setTitle(new Title("Nuclear weapon states"));
    yAxis
        .setLabels(new Labels()
            .setStyle(new CssStyle()));
    setyAxis(yAxis);
    ...
    marker
        .setEnabled(Boolean.TRUE);
    marker
        .setSymbol(new Symbol(PredefinedSymbol.CIRCLE));
    marker
        .setRadius(2);
    marker
