...
public class HomepageChartJs extends WebPage implements Serializable {
    ...
    private List<Chart> getChartFromParams(final PageParameters params) {
        ...
        switch(chartString) {
            ...
            case "timeCombo":
                config.add(new Chart("chart", new TimeComboConfigurationWicket14()));
                break;
            ...
            case "tooltipHtml":
                ...
                config.add(new Chart("chart", new TooltipHtmlPieConfigurationWicket14()));
                config.add(new Chart("chart", new TooltipHtmlPointsConfigurationWicket14()));
                break;
            ...
            case "lineProgressBar":
                config.add(new Chart("chart", new LineChartProgressBarConfigurationWicket14()));
                break;
