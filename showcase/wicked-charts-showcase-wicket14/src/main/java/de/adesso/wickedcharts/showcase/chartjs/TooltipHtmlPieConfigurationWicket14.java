...
import de.adesso.wickedcharts.showcase.options.chartjs.TooltipHtmlPieConfiguration;
...
public class TooltipHtmlPieConfigurationWicket14 extends TooltipHtmlPieConfiguration {
	public TooltipHtmlPieConfigurationWicket14() {
		super();
	}
