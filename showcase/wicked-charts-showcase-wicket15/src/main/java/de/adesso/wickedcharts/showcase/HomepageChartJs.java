...
public class HomepageChartJs extends WebPage implements Serializable {
    ...
    private List<Chart> getChartFromParams(final PageParameters params) {
        ...
        switch(chartString) {
            ...
            case "timeCombo":
                config.add(new Chart(chartComponentID, new TimeComboConfigurationWicket15()));
                break;
            ...
            case "tooltipHtml":
                ...
                config.add(new Chart(chartComponentID, new TooltipHtmlPieConfigurationWicket15()));
                config.add(new Chart(chartComponentID, new TooltipHtmlPointsConfigurationWicket15()));
                break;
            ...
            case "lineProgressBar":
                config.add(new Chart(chartComponentID, new LineChartProgressBarConfigurationWicket15()));
                break;
