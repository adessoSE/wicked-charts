...
public class HomepageChartJs extends WebPage implements Serializable {
    ...
    private List<Chart> getChartFromParams(final PageParameters params) {
        ...
        switch(chartString) {
            ...
            case "timeCombo":
                config.add(new Chart("chart", new TimeComboConfigurationWicket6()));
                break;
            ...
            case "tooltipHtml":
                ...
                config.add(new Chart("chart", new TooltipHtmlPieConfigurationWicket6()));
                config.add(new Chart("chart", new TooltipHtmlPointsConfigurationWicket6()));
                break;
            ...
            case "lineProgressBar":
                config.add(new Chart("chart", new LineChartProgressBarConfigurationWicket6()));
                break;
