...
public class HomepageChartJs extends WebPage implements Serializable {
    ...
    private List<Chart> getChartFromParams(final PageParameters params) {
        ...
        if(params.getAllNamed().isEmpty()){
            ...
            temp.add(chartComponentID, "lineBasic");
        ...
        switch(chartString) {
            ...
            case "timeCombo":
                config.add(new Chart(chartComponentID, new TimeComboConfigurationWicket6()));
                break;
            ...
            case "tooltipHtml":
                ...
                config.add(new Chart(chartComponentID, new TooltipHtmlPieConfigurationWicket6()));
                config.add(new Chart(chartComponentID, new TooltipHtmlPointsConfigurationWicket6()));
                break;
            ...
            case "lineProgressBar":
                config.add(new Chart(chartComponentID, new LineChartProgressBarConfigurationWicket6()));
                break;
