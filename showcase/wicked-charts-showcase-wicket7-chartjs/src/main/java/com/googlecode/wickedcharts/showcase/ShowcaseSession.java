...
public class ShowcaseSession extends WebSession {
  ...
  private ChartConfiguration currentChartOptions;

  public ShowcaseSession(final Request request) {
    super(request);
  }

  public ChartConfiguration getCurrentChartConfiguration() {
    return this.currentChartOptions;
  }

  public void setCurrentChartConfiguration(final ChartConfiguration currentChartOptions) {
