...
public class HomepageChartJs extends WebPage implements Serializable {
    ...
    private List<Chart> getChartFromParams(final PageParameters params) {
        ...
        switch(chartString) {
            ...
            case "timeCombo":
                config.add(new Chart(chartComponentID, new TimeComboConfigurationWicket8()));
                break;
            ...
            case "tooltipHtml":
                ...
                config.add(new Chart(chartComponentID, new TooltipHtmlPieConfigurationWicket8()));
                config.add(new Chart(chartComponentID, new TooltipHtmlPointsConfigurationWicket8()));
                break;
