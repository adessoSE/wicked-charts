...
public class LineChartInterpolationConfigurationTest {
	
	@Test
	public void lineChartInterpolationConfigurationTest() {
		String result = "{\r\n" + 
				"  \"type\" : \"line\",\r\n" + 
				"  \"data\" : {\r\n" + 
				...
				"    \"title\" : {\r\n" + 
				"      \"display\" : true,\r\n" + 
				"      \"text\" : \"Chart.js Line Chart Interpolation\"\r\n" + 
				"    },\r\n" + 
				"    \"tooltips\" : {\r\n" + 
				"      \"mode\" : \"index\",\r\n" + 
				"      \"intersect\" : false\r\n" + 
	...
	private static Data exampleData(){
		...
		Dataset dataset1 = new Dataset()
				...
				.setData(IntegerValue.of(integerList(data.getLabels().size())))
				.setFill(false)
