...
public class PolarAreaChartConfigurationTest {
	
	@Test
	public void polarAreaChartConfigurationTest() {
		String result = "{\r\n" + 
				"  \"type\" : \"polarArea\",\r\n" + 
				"  \"data\" : {\r\n" + 
				...
				"    \"datasets\" : [ {\r\n" + 
				"      \"label\" : \"Dataset 1\",\r\n" + 
				"      \"backgroundColor\" : [ 'rgba(255,99,132,0.50)', 'rgba(255,159,64,0.50)', 'rgba(255,205,86,0.50)', 'rgba(75,192,192,0.50)', 'rgba(54,162,235,0.50)' ],\r\n" + 
				"      \"data\" : [ 0, 1, 2, 3, 4 ]\r\n" + 
				"    } ]\r\n" + 
				"  }\r\n" + 
				"}";
	...
	public static String test() {
		ChartConfiguration config = new ChartConfiguration().setType(ChartType.POLAR_AREA).setData(exampleData());
