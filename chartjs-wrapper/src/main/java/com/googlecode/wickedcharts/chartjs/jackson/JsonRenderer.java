...
//	 this.jacksonModule.addSerializer(SimpleColor.class, new
//	 SimpleColorReferenceSerializer());
//	 this.jacksonModule.addSerializer(HighchartsColor.class, new
//	 HighchartsColorReferenceSerializer());
//	 this.jacksonModule.addSerializer(HexColor.class, new
//	 HexColorReferenceSerializer());
//	 this.jacksonModule.addSerializer(LowercaseEnum.class, new
//	 LowercaseEnumSerializer());
//	 this.jacksonModule.addSerializer(PixelOrPercent.class, new
//	 PixelOrPercentSerializer());
//	 this.jacksonModule.addSerializer(Symbol.class, new SymbolSerializer());
//	 this.jacksonModule.addSerializer(RgbaColor.class, new
//	 RgbaColorReferenceSerializer());
//	 this.jacksonModule.addSerializer(NullColor.class, new
//	 NullColorReferenceSerializer());
//	 this.jacksonModule.addSerializer(MinorTickInterval.class, new
//	 MinorTickIntervalSerializer());
...
//	 this.jacksonModule.addSerializer(DateTimeLabelFormat.class, new
//	 DateTimeLabelFormatSerializer());
//	 this.jacksonModule.addSerializer(Coordinate.class, new
//	 CoordinateSerializer());
//	 this.jacksonModule.addSerializer(Crosshair.class, new CrosshairSerializer());
//	 this.jacksonModule.addSerializer(RangeCoordinate.class, new
//	 RangeCoordinateSerializer());
//	 this.jacksonModule.addSerializer(Bubble.class, new BubbleSerializer());
//	 this.jacksonModule.addSerializer(ThreeDCoordinate.class, new
