...
public class Options implements Serializable {
	 ...
	 * 
	 * @param template
	 *          the {@link Options} object to copy the configuration from.
	 */
	 ...
	 * 
	 * @param processingKey
	 *          the key with which the options in questions were marked.
