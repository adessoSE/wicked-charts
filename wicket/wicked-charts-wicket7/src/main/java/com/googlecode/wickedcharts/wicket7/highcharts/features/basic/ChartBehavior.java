 ...
 */
package com.googlecode.wickedcharts.wicket7.highcharts.features.basic;

import com.googlecode.wickedcharts.highcharts.jackson.JsonRenderer;
import com.googlecode.wickedcharts.highcharts.options.Options;
import com.googlecode.wickedcharts.highcharts.options.processing.*;
...
import com.googlecode.wickedcharts.wicket7.highcharts.features.drilldown.DrilldownProcessor;
import com.googlecode.wickedcharts.wicket7.highcharts.features.global.GlobalProcessor;
import com.googlecode.wickedcharts.wicket7.highcharts.features.interaction.InteractionProcessor;
import com.googlecode.wickedcharts.wicket7.highcharts.features.livedata.LiveDataProcessor;
import com.googlecode.wickedcharts.wicket7.highcharts.features.selection.SelectionProcessor;
...
public class ChartBehavior extends Behavior {
    ...
    private void includeJavascriptDependencies(final IHeaderResponse response, final Options options) {
        ...
        if (OptionsUtil.needsExportingJs(options)) {
            resourceRegistry.getHighchartsExportingEntry().addToHeaderResponse(response);
        }
