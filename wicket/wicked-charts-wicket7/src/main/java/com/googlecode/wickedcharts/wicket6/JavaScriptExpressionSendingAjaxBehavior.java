...
public abstract class JavaScriptExpressionSendingAjaxBehavior extends AbstractDefaultAjaxBehavior {
	 ...
	 * 
	 * @param parameterName
	 *          the name under which the value of the given javascript expression
	 *          can be accessed later
	 * @param javascriptExpression
	 *          the javascript expression whose value pass from client to server.
	 */
	 ...
	 * 
	 * @param parameterMap
	 *          a map containing the name of a parameter as key and a javascript
	 *          expression as value
	 * 
