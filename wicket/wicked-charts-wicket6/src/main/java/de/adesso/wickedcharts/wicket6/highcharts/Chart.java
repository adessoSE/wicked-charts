 ...
 */
package de.adesso.wickedcharts.wicket6.highcharts;

import de.adesso.wickedcharts.highcharts.options.Options;
import de.adesso.wickedcharts.highcharts.theme.Theme;
import de.adesso.wickedcharts.wicket6.highcharts.features.basic.ChartBehavior;
...
public class Chart extends WebMarkupContainer {
    ...
    private void init(final Options options, final Theme theme) {
