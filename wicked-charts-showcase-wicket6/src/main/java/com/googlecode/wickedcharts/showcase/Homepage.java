...
public class Homepage extends WebPage {
	...
	private void addChartLinks(final Chart chart, final Label codeContainer) {
		...
		this.add(new UpdateChartLink("zoomableTimeSeries", chart, codeContainer, new ZoomableTimeSeriesOptions()));
		this.add(new UpdateChartLink("splineInverted", chart, codeContainer, new SplineWithInvertedAxisOptions()));
		this.add(new UpdateChartLink("splineWithPlotBands", chart, codeContainer, new SplineWithPlotBandsOptions()));
		this.add(new UpdateChartLink("polar", chart, codeContainer, new PolarOptions()));
		this.add(new UpdateChartLink("stackedArea", chart, codeContainer, new StackedAreaOptions()));
		this.add(new UpdateChartLink("percentageArea", chart, codeContainer, new PercentageAreaOptions()));
		this.add(new UpdateChartLink("areaMissing", chart, codeContainer, new AreaMissingOptions()));
		this.add(new UpdateChartLink("areaInverted", chart, codeContainer, new AreaInvertedAxisOptions()));

		this.add(new UpdateChartLink("areaSpline", chart, codeContainer, new AreaSplineOptions()));
		this.add(new UpdateChartLink("basicBar", chart, codeContainer, new BasicBarOptions()));
		this.add(new UpdateChartLink("columnWithDrilldown", chart, codeContainer, new ColumnWithDrilldownOptions()));
		this.add(new UpdateChartLink("columnRotated", chart, codeContainer, new ColumnWithRotatedLabelsOptions()));
		this.add(new UpdateChartLink("stackedBar", chart, codeContainer, new StackedBarOptions()));
		...
		this.add(new UpdateChartLink("columnrange", chart, codeContainer, new ColumnRangeOptions()));
		this.add(new UpdateChartLink("arearange", chart, codeContainer, new AreaRangeOptions()));
